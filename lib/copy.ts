...
export const copy = {
  ...
  host: {
    ...
    giftAlongside: "One present from everyone. What it is and roughly what it might come to are yours. Where the money goes and the note to everyone belong to whoever is organising it, on the Gift tab or their own page.",
    giftWhat: "What is it?",
