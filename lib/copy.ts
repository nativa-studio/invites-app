...
export const copy = {
  ...
  host: {
    previewReply: "Tap to change what this asks, including the reply by date. To answer it the way a guest does, switch to Try it as a guest.",
    modeLabel: "How to look at your invite",
    modeEdit: "Change it",
    modeGuest: "Try it as a guest",
