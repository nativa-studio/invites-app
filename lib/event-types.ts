...
export const EVENT_TYPES: EventDefaults[] = [
  {
    ...
    defaults: {
      ask_party_mode: "split", ask_names: true, ask_dietary: true, ask_allergies: true, ask_accessibility: false, ask_emergency: false,
  ...
  },
  {
    ...
    defaults: {
      ask_party_mode: "single", ask_names: true, ask_dietary: true, ask_allergies: true, ask_accessibility: false, ask_emergency: false,
  ...
  },
  {
    ...
    defaults: {
      ask_party_mode: "single", ask_names: false, ask_dietary: false, ask_allergies: false, ask_accessibility: true, ask_emergency: false,
