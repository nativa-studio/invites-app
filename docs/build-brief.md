...
| Invite looks | Three modes: text only, gallery theme (six originals), uploaded invite (PDF, PNG, JPG). One layout below the hero. |
...
4. **Looks.** Upload with PDF conversion, details strip, accent extraction, six gallery themes, share card, live preview in the Look step.
